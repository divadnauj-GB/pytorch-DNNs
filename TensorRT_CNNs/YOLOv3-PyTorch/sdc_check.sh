...
cp ${APP_DIR}/results/inference/results.csv . 
if [ -f ${APP_DIR}/results/inference/results.csv ]; then
    diff ${APP_DIR}/results/inference/golden_results.csv ${APP_DIR}/results/inference/results.csv > diff.log 
else
    touch diff.log
fi
...
rm ${APP_DIR}/results/inference/results.csv 
